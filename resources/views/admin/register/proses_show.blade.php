...
@section('isi')
    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-custom bg-danger">
                ...
                <li class="breadcrumb-item"><a href="{{ route('list.valid') }}" style="color: var(--secondary-color)">List Proses Sertifikasi</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        {{-- RIGHT COLUMN: Status, Verification & Documents --}}
                        <div class="col-lg-8 pl-lg-5">
                            ...
                            {{-- Verification Button --}}
                            <button class="btn btn-success btn-block mb-3" data-toggle="modal" data-target="#verifikasi-{{ $validasi->id }}">
                                <i class="fas fa-check-circle"></i> Verifikasi Data Sertifikasi
                            </button>
                            ...
                            <hr class="my-2">
                            <table class="table table-bordered table-sm">
                                <tr><td class="text-muted" style="width:140px">Tanggal Uji Kompetensi</td><td>{{ $validasi->date ? $validasi->date->format('d-M-Y') : '-' }}</td></tr>
                                <tr><td class="text-muted">Waktu Uji Kompetensi</td><td>{{ $validasi->time ?? '-' }}</td></tr>
                                <tr><td class="text-muted">Lokasi Uji Kompetensi</td><td>{{ $validasi->tuk?->tuk ?? '-' }}</td></tr>
                                <tr><td class="text-muted">Asesor Penguji</td><td>{{ $validasi->asesor?->nama ?? '-' }}</td></tr>
                            </table>
    ...
    {{-- MODAL VERIFIKASI --}}
    <div class="modal fade" id="verifikasi-{{ $validasi->id }}" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fas fa-check-circle"></i> {{ $validasi->user_name }}</h5>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    Apakah anda yakin untuk memverifikasi data ini sebagai <strong>Sertifikasi Selesai</strong>?
                </div>
