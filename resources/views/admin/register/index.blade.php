...
@section('judul')
    Data Pendaftaran Terbaru | Admin LSP
@endsection
    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-custom bg-danger">
                ...
                <li class="breadcrumb-item active" style="color: #fff" aria-current="page">Data Pendaftaran Terbaru</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="alert alert-info d-flex align-items-center" role="alert">
                ...
                <span>Tabel ini menampilkan pendaftaran sertifikasi yang belum divalidasi. Klik <strong>Proses Data</strong> untuk memvalidasi.</span>
            </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('validasi.show', $asu->id) }}">
                                                <i class="fa fa-magic text-info"></i> Proses Data
                                            </a>
